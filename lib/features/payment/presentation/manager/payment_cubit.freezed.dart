...
abstract class Initial<T> implements PaymentState<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$PaymentStateCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
abstract class Failure<T> implements PaymentState<T> {
