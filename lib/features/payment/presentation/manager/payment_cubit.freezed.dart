...
mixin _$PaymentState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PaymentState<T>);
  }
  ...
  @override
  String toString() {
    return 'PaymentState<$T>()';
  }
}

/// @nodoc
class $PaymentStateCopyWith<T, $Res> {
  $PaymentStateCopyWith(PaymentState<T> _, $Res Function(PaymentState<T>) __);
}

/// Adds pattern-matching-related methods to [PaymentState].
extension PaymentStatePatterns<T> on PaymentState<T> {
...
class Initial<T> implements PaymentState<T> {
  const Initial();
...
class Loading<T> implements PaymentState<T> {
  const Loading();
...
class Success<T> implements PaymentState<T> {
...
class Failure<T> implements PaymentState<T> {
  ...
  @override
  String toString() {
    return 'PaymentState<$T>.failure(message: $message)';
  }
}
