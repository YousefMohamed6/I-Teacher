...
class PaymentService {
  ...
  void initDi() {
    ...
    sl.registerLazySingletonSafely<FetchPaymentMethodsUseCase>(
      () => FetchPaymentMethodsUseCase(sl()),
    );
    sl.registerLazySingletonSafely<SendPaymentRequestUseCase>(
      () => SendPaymentRequestUseCase(sl()),
    );
    sl.registerLazySingletonSafely<GetCoursePriceUseCase>(
      () => GetCoursePriceUseCase(sl()),
    );
