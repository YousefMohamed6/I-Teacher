...
abstract class $PrivacyPolicyStateCopyWith<T, $Res> {
  factory $PrivacyPolicyStateCopyWith(TermsAndConditionsState<T> value,
          $Res Function(TermsAndConditionsState<T>) then) =
      _$PrivacyPolicyStateCopyWithImpl<T, $Res, TermsAndConditionsState<T>>;
}

/// @nodoc
class _$PrivacyPolicyStateCopyWithImpl<T, $Res,
        $Val extends TermsAndConditionsState<T>>
...
abstract class Initial<T> implements TermsAndConditionsState<T> {
...
abstract class Loading<T> implements TermsAndConditionsState<T> {
...
abstract class Success<T> implements TermsAndConditionsState<T> {
...
abstract class Error<T> implements TermsAndConditionsState<T> {
