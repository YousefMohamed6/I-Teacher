...
mixin _$ChatbotState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ChatbotState<T>);
  }
  ...
  @override
  String toString() {
    return 'ChatbotState<$T>()';
  }
}

/// @nodoc
class $ChatbotStateCopyWith<T, $Res> {
  $ChatbotStateCopyWith(ChatbotState<T> _, $Res Function(ChatbotState<T>) __);
}

/// Adds pattern-matching-related methods to [ChatbotState].
extension ChatbotStatePatterns<T> on ChatbotState<T> {
...
class Initial<T> implements ChatbotState<T> {
  const Initial();
...
class Loading<T> implements ChatbotState<T> {
  const Loading();
...
class Success<T> implements ChatbotState<T> {
...
class Failure<T> implements ChatbotState<T> {
  ...
  @override
  String toString() {
    return 'ChatbotState<$T>.failure(message: $message)';
  }
}
...
class UpdateUI<T> implements ChatbotState<T> {
  const UpdateUI();
  ...
  @override
  String toString() {
    return 'ChatbotState<$T>.updateUI()';
  }
}
