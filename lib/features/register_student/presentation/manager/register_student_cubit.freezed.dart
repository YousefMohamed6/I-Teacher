...
mixin _$StudentState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is StudentState<T>);
  }
  ...
  @override
  String toString() {
    return 'StudentState<$T>()';
  }
}

/// @nodoc
class $StudentStateCopyWith<T, $Res> {
  $StudentStateCopyWith(StudentState<T> _, $Res Function(StudentState<T>) __);
}

/// Adds pattern-matching-related methods to [StudentState].
extension StudentStatePatterns<T> on StudentState<T> {
...
class Initial<T> implements StudentState<T> {
  const Initial();
...
class Loading<T> implements StudentState<T> {
  const Loading();
...
class Success<T> implements StudentState<T> {
...
class Failure<T> implements StudentState<T> {
