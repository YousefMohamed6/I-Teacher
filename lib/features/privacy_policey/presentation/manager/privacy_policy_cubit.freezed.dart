...
abstract class Initial<T> implements PrivacyPolicyState<T> {
...
abstract class Loading<T> implements PrivacyPolicyState<T> {
...
abstract class Success<T> implements PrivacyPolicyState<T> {
...
abstract class Error<T> implements PrivacyPolicyState<T> {
