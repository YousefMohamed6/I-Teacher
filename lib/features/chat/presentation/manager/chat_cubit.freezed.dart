...
mixin _$ChatState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ChatState<T>);
  }
...
class Initial<T> implements ChatState<T> {
  const Initial();
...
class Loading<T> implements ChatState<T> {
  const Loading();
...
class Failure<T> implements ChatState<T> {
...
class Success<T> implements ChatState<T> {
...
class UpdateUI<T> implements ChatState<T> {
  const UpdateUI();
